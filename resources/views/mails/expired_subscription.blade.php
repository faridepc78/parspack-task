                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                               role="presentation"
                               style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000; background-color: #1aa19c; width: 640px; margin: 0 auto;"
                               width="640">
                            <tbody>
                            <tr>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-left:40px;padding-right:40px;width:100%;">
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                        alt="I'm an image" class="fullWidth"
                                                        src="{{asset('assets/images/Img3_2x.jpg')}}"
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;">
                                                            <span style="font-size:30px;color:#2b303a;"><strong>You have a new message</strong></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-3"
                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;">
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                        alt="I'm an image" src="{{$user->profile}}"
                                                        style="height: auto; display: block; border: 0; max-width: 72px; width: 100%;"
                                                        title="I'm an image" width="72"/></div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block block-4"
                                            ...
                                            <td class="pad"
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;">
                                                            <span
                                                                style="color:#2b303a;font-size:18px;"><strong>{{$user->name}}</strong></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                                    ...
                                                    <div class=""
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 22.5px;">
                                                            <span style="color:#2b303a;font-size:15px;">
                                                                <strong>app subscription with id: {{ $app->id }} and name: {{ $app->name }} has expired</strong>
                                                                <br>
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 22.5px;">
                                                            <span
                                                                style="color:#2b303a;font-size:15px;">Thank you</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="pad"
                                                ...
                                                <div align="center" class="alignment"><!--[if mso]>
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 style="height:62px;width:161px;v-text-anchor:middle;"
                                                    ...
                                                    <![endif]-->
                                                    <div
                                                        style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#1aa19c;border-radius:60px;width:auto;border-top:0px solid transparent;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:15px;padding-bottom:15px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                        <a target="_blank" href="{{ route('api.v1.apps.show',$app->id) }}"
                                                            style="text-decoration: none;color: #FFFFFF;padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                style="margin: 0; word-break: break-word; line-height: 32px;"><strong>See Details</strong></span></a>
                                                    </div>
                                ...
                                <td class="column column-1"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-2"
                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;">
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                        alt="I'm an image" src="{{asset('assets/images/footer.png')}}"
                                                        style="height: auto; display: block; border: 0; max-width: 640px; width: 100%;"
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-top:40px;width:100%;">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <h1 style="color: #BBBBBB">Parspack</h1>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                                        ...
                                                        <tr>
                                                            <td style="padding:0 10px 0 10px;"><a
                                                                    href="https://www.facebook.com" target="_blank"><img
                                                                        ...
                                                                        src="{{asset('assets/images/facebook2x.png')}}"
                                                            ...
                                                            <td style="padding:0 10px 0 10px;"><a
                                                                    href="https://www.twitter.com" target="_blank"><img
                                                                        ...
                                                                        src="{{asset('assets/images/twitter2x.png')}}"
                                                                        style="height: auto; display: block; border: 0;"
                                                                        title="Twitter" width="32"/></a></td>
                                                            <td style="padding:0 10px 0 10px;"><a
                                                                    href="https://www.instagram.com"
                                                                    target="_blank"><img alt="Instagram" height="32"
                                                                                         src="{{asset('assets/images/instagram2x.png')}}"
                                                                                         style="height: auto; display: block; border: 0;"
                                                            ...
                                                            <td style="padding:0 10px 0 10px;"><a
                                                                    href="https://www.linkedin.com" target="_blank"><img
                                                                        ...
                                                                        src="{{asset('assets/images/linkedin2x.png')}}"
                                                                        style="height: auto; display: block; border: 0;"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block block-7"
                                           role="presentation"
                                           style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;"
                                           width="100%">
                                        <tr>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                            <span style="color:#95979c;font-size:12px;">Parspack Copyright © 2023</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
